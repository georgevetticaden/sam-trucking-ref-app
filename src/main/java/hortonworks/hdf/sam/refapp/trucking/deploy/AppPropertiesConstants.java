...
public class AppPropertiesConstants {
	...
	public static final String SAM_REF_APP_ADVANCE_FILE_LOCATION = "/3.1.0.0-404/streaming-ref-app-advanced.json";
	public static final String SAM_REF_APP_FILE_LOCATION = "/3.1.0.0-404/streaming-ref-app.json";
