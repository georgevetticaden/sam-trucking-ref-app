...
public class PropertiesConstants {
	...
	/* Other Constants */
	public static final String SAM_REF_APP_ADVANCE_FILE_LOCATION = "/3.1.0.0-560/streaming-ref-app-advanced.json";
	public static final String SAM_REF_APP_FILE_LOCATION = "/3.1.0.0-560/streaming-ref-app.json";
